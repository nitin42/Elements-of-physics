...
export const ForceContent = props => (
  <React.Fragment>
    ...
    <p>
      ...
      <span>constant</span> velocity. Rendering balls on canvas using{' '}
      <span>Force</span> shares a similar mechanism when compared to{' '}
    ...
    <p>
      The value of mass is a pseudo-random number between the inclusive range 0
    ...
    <p>
      ...
      More its value, more the friction. After you've enabled the friction, you
      will notice that the ball moves slowly and then reaches the edge. It stops
      accelerating further after it has reached the edge. Frictional force
      reduces the energy of a system while the ball is in motion.
    </p>
    <blockquote>
      Symbolic expression for friction force is -uNV. The negative sign
    ...
    <blockquote>
      Note - You can add multiple force vectors for a ball using apply force
      option in control section.
    </blockquote>
  </React.Fragment>
)
