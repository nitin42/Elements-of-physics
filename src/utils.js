...
class DrawBalls {
	constructor(instance, props) {
		...
		this.loc = new Vector(Math.random(this.instance.width / 2), Math.random(this.instance.height / 2))
	...
	displayBalls() {
		...
		this.instance.ellipse(this.loc.x, this.loc.y, this.props.ballSize.width, this.props.ballSize.height)
	}
}
